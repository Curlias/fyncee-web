    ...
    <main className="min-h-screen">
      ...
      <section className="pt-32 pb-24 bg-dark-bg">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-h1 sm:text-[56px] font-bold mb-8 text-white">
            Términos de Servicio
          </h1>
          <p className="text-body text-white mb-12">
            Última actualización: 25 de noviembre de 2025
          </p>

          <div className="prose prose-invert max-w-none space-y-8">
            <div className="bg-dark-surface rounded-card p-8">
              <h2 className="text-h3 font-bold mb-4 text-white">1. Aceptación de términos</h2>
            ...
            <div className="bg-dark-surface rounded-card p-8">
              <h2 className="text-h3 font-bold mb-4 text-white">2. Uso del servicio</h2>
              ...
              <ul className="list-disc list-inside space-y-2 text-body text-white mt-4">
            ...
            <div className="bg-dark-surface rounded-card p-8">
              <h2 className="text-h3 font-bold mb-4 text-white">3. Cuenta de usuario</h2>
              <p className="text-body text-white leading-relaxed">
            ...
            <div className="bg-dark-surface rounded-card p-8">
              <h2 className="text-h3 font-bold mb-4 text-white">4. Propiedad intelectual</h2>
              <p className="text-body text-white leading-relaxed">
            ...
            <div className="bg-dark-surface rounded-card p-8">
              <h2 className="text-h3 font-bold mb-4 text-white">5. Tus datos</h2>
              <p className="text-body text-white leading-relaxed">
            ...
            <div className="bg-dark-surface rounded-card p-8">
              <h2 className="text-h3 font-bold mb-4 text-white">6. Exención de garantías</h2>
              <p className="text-body text-white leading-relaxed">
            ...
            <div className="bg-dark-surface rounded-card p-8">
              <h2 className="text-h3 font-bold mb-4 text-white">7. Limitación de responsabilidad</h2>
              <p className="text-body text-white leading-relaxed">
            ...
            <div className="bg-dark-surface rounded-card p-8">
              <h2 className="text-h3 font-bold mb-4 text-white">8. Modificaciones del servicio</h2>
              <p className="text-body text-white leading-relaxed">
            ...
            <div className="bg-dark-surface rounded-card p-8">
              <h2 className="text-h3 font-bold mb-4 text-white">9. Terminación</h2>
              <p className="text-body text-white leading-relaxed">
            ...
            <div className="bg-dark-surface rounded-card p-8">
              <h2 className="text-h3 font-bold mb-4 text-white">10. Cambios a los términos</h2>
              <p className="text-body text-white leading-relaxed">
            ...
            <div className="bg-dark-surface rounded-card p-8">
              <h2 className="text-h3 font-bold mb-4 text-white">11. Contacto</h2>
              <p className="text-body text-white leading-relaxed">
