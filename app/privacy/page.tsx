        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="prose prose-invert max-w-none space-y-8">
            <div className="bg-dark-surface rounded-card p-8">
              <h2 className="text-h3 font-bold mb-4 text-white">1. Información que recopilamos</h2>
              <p className="text-body text-white leading-relaxed mb-4">
                Fyncee recopila la siguiente información:
              </p>
              <ul className="list-disc list-inside space-y-2 text-body text-white">
            ...
            <div className="bg-dark-surface rounded-card p-8">
              <h2 className="text-h3 font-bold mb-4 text-white">2. Cómo usamos tu información</h2>
              <p className="text-body text-white leading-relaxed mb-4">
            ...
            <div className="bg-dark-surface rounded-card p-8">
              <h2 className="text-h3 font-bold mb-4 text-white">3. Seguridad de los datos</h2>
            ...
            <div className="bg-dark-surface rounded-card p-8">
              <h2 className="text-h3 font-bold mb-4 text-white">4. Compartir información</h2>
              <p className="text-body text-white leading-relaxed">
            ...
            <div className="bg-dark-surface rounded-card p-8">
              <h2 className="text-h3 font-bold mb-4 text-white">5. Tus derechos</h2>
              <p className="text-body text-white leading-relaxed">
                Tienes derecho a:
              </p>
              <ul className="list-disc list-inside space-y-2 text-body text-white mt-4">
            ...
            <div className="bg-dark-surface rounded-card p-8">
              <h2 className="text-h3 font-bold mb-4 text-white">6. Cookies y tecnologías similares</h2>
              <p className="text-body text-white leading-relaxed">
            ...
            <div className="bg-dark-surface rounded-card p-8">
              <h2 className="text-h3 font-bold mb-4 text-white">7. Cambios a esta política</h2>
              <p className="text-body text-white leading-relaxed">
            ...
            <div className="bg-dark-surface rounded-card p-8">
              <h2 className="text-h3 font-bold mb-4 text-white">8. Contacto</h2>
              <p className="text-body text-white leading-relaxed">
