        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-24">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                <h2 className="text-h2 font-bold mb-6">Registra gastos en segundos</h2>
              ...
              <div className="bg-dark-surface rounded-card p-8 aspect-square flex items-center justify-center">
                <p className="text-text-tertiary">Screenshot: Agregar transacción</p>
              </div>
            </div>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="order-2 lg:order-1 bg-dark-surface rounded-card p-8 aspect-square flex items-center justify-center">
                <p className="text-text-tertiary">Screenshot: Presupuestos</p>
              </div>
              <div className="order-1 lg:order-2">
                <h2 className="text-h2 font-bold mb-6">Controla tus límites de gasto</h2>
                <p className="text-h4 text-text-secondary mb-8">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                <h2 className="text-h2 font-bold mb-6">Entiende a dónde va tu dinero</h2>
                <p className="text-h4 text-text-secondary mb-8">
              ...
              <div className="bg-dark-surface rounded-card p-8 aspect-square flex items-center justify-center">
                <p className="text-text-tertiary">Screenshot: Estadísticas</p>
              </div>
            </div>
          </div>
